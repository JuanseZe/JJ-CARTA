...
var user = [
 
    {
        ...
        interest: ' expert. Music scholar. FoodReader. Internet fanatic. Bacon buff. Entrepreneur. Travel geek. Pop culture ninja. Coffee fanatic.'
    },
    {
...
for (var i = 0; i < user.length; i++) {
    ...
    elementContainer.innerHTML += `<img class="photo" src="${user[i].photo}"></img>`
    
    elementContainer.innerHTML += ` 
    <div id="info">
        <div class="Informe">
        <p id="name">${user[i].name}</p>
        <p id="inf">${user[i].profesion}</p>
        <p id="web">${user[i].website}</p>
        </div>
        ...
        <p class="infoPersonal">About<p class="DescripcionP">${user[i].about}</p></p>
        <p class="infoPersonal">interests<p class="DescripcionP">${user[i].interest}</p></p>
    </div>
    <div id="social-icons">
